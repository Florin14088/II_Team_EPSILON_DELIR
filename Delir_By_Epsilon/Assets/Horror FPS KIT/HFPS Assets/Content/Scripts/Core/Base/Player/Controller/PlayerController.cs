...
public class PlayerController : Singleton<PlayerController>
{
    ...
    public void UseLadder(Transform center, Vector2 look, bool climbUp)
    {
        ...
        if (climbUp)
        {
            ...
            scriptManager.GetComponent<MouseLook_HFPS>().LerpLook(look, climbUpAutoLook, true);
        }
        else
        {
            StartCoroutine(MovePlayer(center.position, climbDownAutoMove, true));
            scriptManager.GetComponent<MouseLook_HFPS>().LerpLook(look, climbDownAutoLook, true);
        }
    ...
    public void LadderExit()
    {
        if (ladderReady)
        {
            ...
            ladderReady = false;
            scriptManager.GetComponent<MouseLook_HFPS>().LockLook(false);
    ...
    public void LerpPlayer(Vector3 destination, Vector2 look, bool lerpLook = true)
    {
        ...
        if (lerpLook)
        {
            scriptManager.GetComponent<MouseLook_HFPS>().LerpLook(look, globalAutoLook, true);
        }
    }
